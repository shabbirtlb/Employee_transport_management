  ...
  .sidebar a {
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a class="active" href="Oe.php">Employees</a>
        ...
        <center><form class="box" method="POST" action="oesin.php" style="margin-top:50px">    
        <input type ="text"  placeholder="Enter Employee name.." name="emp" ?>
