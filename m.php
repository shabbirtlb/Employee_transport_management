  ...
  .sidebar a {
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a class="active" href="m.php">Mechanics</a>
          </div>
        <div class="content">          
        <form class="box" action="hm.php" method="POST">
          <input type="text" placeholder="Enter Mechanic's Name" name="d">
          <button type="submit">Hire</button>
</form>
        <div class="card" style="background-color:#3d3d3d60;color:#ffffff;margin-bottom: 5px;border-radius: 15px;">

<h2>Mechanics employed :</h2>
<div class="grid-container">
      <div class="row">
      <?php

$query2="select * from user where compname ='$company' and Type like'Mechanic'";
